...
namespace UrbanInfraSystem.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        {
            // ============================================================
            // ASP.NET Core Identity tables (renamed)
            // ============================================================
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Boundary = table.Column<object>(type: "geography", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(name: "AuditLogId", type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE IssueAssignments
                ADD CONSTRAINT CK_IssueAssignments_Method
                CHECK (AssignmentMethod IN ('AUTO', 'MANUAL', 'TRANSFER', 'ESCALATION'));
            ");
            migrationBuilder.Sql(@"
                ALTER TABLE IssueAssignmentMembers
                ADD CONSTRAINT CK_IssueAssignmentMembers_Status
                CHECK (Status IN ('PENDING', 'ACCEPTED', 'REJECTED', 'COMPLETED'));
            ");
            migrationBuilder.Sql(@"
                ALTER TABLE SlaPolicies
                ADD CONSTRAINT CK_SlaPolicies_Minutes_Positive
                CHECK (ResolutionMinutes > 0 AND FirstResponseMinutes > 0);
            ");
        }
        ...
        {
            migrationBuilder.Sql("ALTER TABLE IssueAssignments DROP CONSTRAINT CK_IssueAssignments_Method;");
            migrationBuilder.Sql("ALTER TABLE IssueAssignmentMembers DROP CONSTRAINT CK_IssueAssignmentMembers_Status;");
            migrationBuilder.Sql("ALTER TABLE SlaPolicies DROP CONSTRAINT CK_SlaPolicies_Minutes_Positive;");

            migrationBuilder.DropTable(name: "AuditLogs");
            migrationBuilder.DropTable(name: "DepartmentMembers");
            migrationBuilder.DropTable(name: "EscalationEvents");
            migrationBuilder.DropTable(name: "EscalationRules");
            migrationBuilder.DropTable(name: "IssueAssignmentMembers");
            migrationBuilder.DropTable(name: "IssueAttachments");
            migrationBuilder.DropTable(name: "IssueSlas");
            migrationBuilder.DropTable(name: "IssueUpvotes");
            migrationBuilder.DropTable(name: "Notifications");
            migrationBuilder.DropTable(name: "RefreshTokens");
            migrationBuilder.DropTable(name: "ReRouteRequests");
            migrationBuilder.DropTable(name: "ReportIssueTypes");
            migrationBuilder.DropTable(name: "ReportUpvotes");
            ...
            migrationBuilder.DropTable(name: "IssueAssignments");
            migrationBuilder.DropTable(name: "IssueUpdates");
            ...
            migrationBuilder.DropTable(name: "SlaPolicies");

            migrationBuilder.DropTable(name: "IssuePriorities");
            migrationBuilder.DropTable(name: "IssueTypes");
            migrationBuilder.DropTable(name: "Departments");
            migrationBuilder.DropTable(name: "Areas");
            migrationBuilder.DropTable(name: "IssueStatuses");
