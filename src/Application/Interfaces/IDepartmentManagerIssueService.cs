...
{
    Task<PaginatedResponse<DepartmentManagerIssueSummary>> GetIssuesAsync(int departmentId, DepartmentManagerIssueListRequest request, CancellationToken cancellationToken = default);
